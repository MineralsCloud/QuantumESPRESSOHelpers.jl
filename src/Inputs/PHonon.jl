...
using ..Inputs: namelist_builder, setfield_helper

import QuantumESPRESSOHelpers.Inputs

function Inputs.namelist_builder(terminal::TTYTerminal, ::Type{T}) where {T<:PhNamelist}
    print(
        terminal,
...
function Inputs.namelist_builder(terminal::TTYTerminal, ::Type{T}) where {T<:Q2rNamelist}
